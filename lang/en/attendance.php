...
$string['sessionstatuscomplete'] = 'Complete';
$string['sessionstatusincomplete'] = 'Incomplete: {$a->takenusers}/{$a->totalusers}';
$string['sessionstatusnousers'] = 'No users';
$string['sessionstatusnotstarted'] = 'Not started';
